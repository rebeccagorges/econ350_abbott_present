...
\end{itemize}   
\hyperlink{Psychic Costs}{\beamerbutton{Psychic Costs}}
\end{frame}   
...
\begin{frame}[label=ReturnModel]{Intergenerational Linkages: Transmission of Abilities}
\begin{itemize}
...
\end{itemize}      
\hyperlink{Caucutt}{\beamerbutton{Caucutt}}
\end{frame} 
...
\end{itemize}      
\hyperlink{Altruism}{\beamerbutton{Altruism}}
\end{frame} 
...
\tiny{Navarro, Zhou (2016)} &\tiny{Ability gradient on psychic costs much higher than Abbott et al}  \\\hline
\end{tabular}
\end{center}
\end{table}
...
\begin{frame}[label=Caucutt]{Caucutt et al (2017): Role of information frictions}
\begin{itemize}
...
\end{itemize}
\end{itemize}
\hyperlink{ReturnModel}{\beamerbutton{Return}}
\end{frame}
